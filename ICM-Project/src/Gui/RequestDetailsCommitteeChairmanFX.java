...
public class RequestDetailsCommitteeChairmanFX implements BaseFx {
	...
	// Class variables *************************************************
	private RequestDetailsCommitteeChairmanController requestDetailsCommitteeChairmanController;
	...
	public void backWasPressed(ActionEvent event) {
		...
		requestDetailsCommitteeChairmanController.switchScene("ViewAllRequests");
	}

	@FXML
	public void homeWasPressed(ActionEvent event) {

		requestDetailsCommitteeChairmanController.switchScene("AcademicUserPanel");
	}
